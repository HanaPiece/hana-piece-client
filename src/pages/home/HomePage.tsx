...
const GoalBox = ({
  ...
  return (
    <div
      className={`bg-gradient-to-r ${gradientClass} rounded-2xl p-3 my-4 text-white shadow-xl cursor-pointer`}
      onClick={() => goToDetail(userGoalId)}
    >
    ...
    <div className="m-10">
      ...
      <div className="py-5">
        <h2 className="font-black text-2xl">
          현재 저축액: {addCommas(totalAmount)} 원
        </h2>
      </div>
      <GoalBox
        userGoalId={1}
